...
createShaderBuffers = do
    ...
    let (w, h) = (760, 14)
    let (w', h') = (w/2, h/2)
    let vertices = [ Vertex2 (-w'-0.5) ( h'-0.5), Vertex2 (0.0) (0.0)
                   , Vertex2 ( w'-0.5) ( h'-0.5), Vertex2 (1.0) (0.0)
                   , Vertex2 ( w'-0.5) (-h'-0.5), Vertex2 (1.0) (1.0)
                   , Vertex2 (-w'-0.5) (-h'-0.5), Vertex2 (0.0) (1.0)
                   ] :: [Vertex2 GLfloat]
